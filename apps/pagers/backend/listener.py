...
frequency picker): POCSAG512/1200/2400 on 172.45 MHz. Same decoders as
plugins/apps/pocsag/backend/listener.py's PocsagListener (439.9875 MHz
instead) -- Pagers is the third and last of the former combined
`src/audio/pager_listener.py` kinds to become its own plugin (after
P2000 and POCSAG); that shared file is gone now, nothing else needs it.
